    ...
    <div class="col-xl-7">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo site_url('writer/manage_profile/update_profile_info/' . $edit_data['id']) ?>" method="POST" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data">
