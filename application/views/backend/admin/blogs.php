        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo $page_title; ?>
                    <a href="<?php echo site_url('admin/blog_form') ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_new_blog'); ?></a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row justify-content-center" action="<?php echo site_url('admin/blogs'); ?>" method="get">
                    <div class="col-xl-4">
                            ...
                            <tbody>
                                <?php foreach ($blogs as $key => $blog) : ?>
                                    <tr class="<?php echo $blog['blog_visibility'] ? 'published-blog' : 'unpublished-blog'; ?>">
                                        <td><?php echo ++$key; ?></td>
                                        <td><strong><a class="text-color" href="<?php echo site_url('admin/blog_form/' . $blog['blog_id']); ?>"><?php echo ellipsis($blog['blog_title'], 60); ?></a></strong></td>
                                        ...
                                        <td>
                                            <div class="dropright dropright">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a class="dropdown-item" href=<?php echo site_url('admin/blog_form/' . $blog['blog_id']); ?>><?php echo get_phrase('edit'); ?></a></li>
                                                    <li><a class="dropdown-item" href="javascript:void(0)" onclick="confirm_modal('<?php echo site_url('admin/blog/delete/' . $blog['blog_id']); ?>');"><?php echo get_phrase('delete'); ?></a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
