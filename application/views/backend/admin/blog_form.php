        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo $page_title; ?>
                    <a href="<?php echo site_url('admin/blogs/'); ?>" class="btn btn-outline-secondary btn-rounded alignToTitle"><?php echo get_phrase('back_to_blog_list'); ?></a>
...
<div class="row justify-content-center">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <!-- Articles list ends-->
                <form class="" action="<?php echo site_url('admin/blog_action/store'); ?>" method="post" enctype="multipart/form-data">
