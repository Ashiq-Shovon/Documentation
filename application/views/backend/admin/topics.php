        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <?php echo get_phrase('topics_and_aricles_of_product'); ?> : <?php echo $product_details['name']; ?>
                    <a href="<?php echo site_url('admin/documentation'); ?>" class="btn btn-outline-secondary btn-rounded alignToTitle ml-1"><i class="mdi mdi-arrow-left"></i><?php echo get_phrase('back_to_products'); ?></a>
            ...
            <div class="card d-block <?php if ($topic['visibility'] == 1) : ?> published <?php else : ?> unpublished <?php endif; ?>">
                    ...
                    <?php foreach ($articles as $article) : ?>
                        <li class="list-group-item on-hover-action" id="article-<?php echo $article['id']; ?>">
                            ...
                            <span class="category-action" id='delete-article-<?php echo $article['id']; ?>' style="float: right; margin-left: 5px; display: none; height: 20px;">
                                <a href="javascript:void(0)" class="action-icon" onclick="confirm_modal('<?php echo site_url('admin/article/delete/' . $article['id']); ?>');"> <i class="mdi mdi-delete" style="font-size: 18px;"></i></a>
                            </span>
                            ...
                            <span class="category-action" id='documentation-for-article-<?php echo $article['id']; ?>' style="float: right; display: none; height: 20px;">
                                <a href="<?php echo site_url('admin/documentation_details/' . $article['slug'] . '-' . $article['id']); ?>" class="action-icon"> <i class="mdi mdi-file-document-box-multiple-outline" style="font-size: 18px;"></i></a>
                            </span>
                        </li>
                    <?php endforeach; ?>
                </ul>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <a href="#" class="btn btn-icon btn-outline-danger btn-sm btn-block" id="delete-topic-<?php echo $topic['id']; ?>" style="float: right; display: none;" onclick="confirm_modal('<?php echo site_url('admin/topic_action/delete/' . $topic['id']); ?>');" style="margin-right:5px;">
