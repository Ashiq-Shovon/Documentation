    ...
    <div class="container-fluid">
        ...
        <a href="<?php echo site_url($this->session->userdata('role')); ?>" class="topnav-logo" style="min-width: unset;">
            <span class="topnav-logo-lg">
                <img src="<?php echo base_url('uploads/thumbnails/system/logo-light.png'); ?>" alt="" height="40">
            </span>
            <span class="topnav-logo-sm">
                <img src="<?php echo base_url('uploads/thumbnails/system/logo-light-sm.png'); ?>" alt="" height="40">
            </span>
        </a>
            ...
            <li class="dropdown notification-list">
                <a class="nav-link dropdown-toggle nav-user arrow-none mr-0" data-toggle="dropdown" id="topbar-userdrop" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span style="color: #fff;">
                        ...
                        ?>
                        <span class="account-user-name"><?php echo $logged_in_user_details['name']; ?></span>
        ...
        <div class="visit_website">
            ...
            <a href="<?php echo site_url(); ?>" target="_blank" class="btn btn-outline-light ml-3"><?php echo get_phrase('visit_website'); ?></a>
        </div>
    </div>
</div>
<!-- end Topbar -->