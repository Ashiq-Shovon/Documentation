    ...
    <div class="col-md-6 col-xl-3 on-hover-action" id="<?php echo $product['id']; ?>">
        ...
        <div class="card d-block">
            ...
            <img class="card-img-top"
                src="<?php echo base_url('uploads/thumbnails/products/' . $product['thumbnail']); ?>"
            ...
            <div class="card-body position-relative min-height-155">
                <!-- project title-->
                <h4 class="mt-0">
                    <a href="<?php echo site_url('writer/topics/' . $product['slug']) ?>"
                        class="text-title"><?php echo $product['name']; ?></a>
                </h4>
                <!-- project detail-->
                <p class="mb-3">
                ...
                <a href="<?php echo site_url('writer/topics/' . $product['slug']) ?>"
                    class="btn btn-primary btn-block"><?php echo get_phrase('go_to_documentations'); ?></a>
                <a href="javascript:;" class="btn btn-success mt-2 text-center w-100"
                    onclick="showAjaxModal('<?php echo site_url('writer/select_article_to_export/'.$product['slug']) ?>', '<?php echo $product['name']; ?>')">Export
                    Documentation</a>
            </div> <!-- end card-body-->
        </div> <!-- end card-->
    </div> <!-- end col -->
